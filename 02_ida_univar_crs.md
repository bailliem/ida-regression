...
```
    ...
    ## here() starts at C:/Users/Mark/Documents/ida-regression
...
![](02_ida_univar_crs_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
```
    ...
    ## [1] here_0.1        Hmisc_4.2-0     Formula_1.2-3   survival_2.43-3
    ...
    ## [28] backports_1.1.4     scales_1.0.0        checkmate_1.9.4    
    ...
    ## [43] zeallot_0.1.0       Matrix_1.2-15       data.table_1.12.2  
